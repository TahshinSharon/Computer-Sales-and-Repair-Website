...
if(isset($_REQUEST['submitrequest'])){
        if(($_REQUEST['requestinfo']=="") || ($_REQUEST['requestdesc']=="") || ($_REQUEST['requestername']=="")|| ($_REQUEST['requesteradd1']=="") || ($_REQUEST['requesteradd2']=="") || ($_REQUEST['requestercity']=="") || ($_REQUEST['requesterstate']=="") || ($_REQUEST['requesterzip']=="") || ($_REQUEST['requesteremail']=="") || ($_REQUEST['requestermobile']=="") || ($_REQUEST['requestdate']=="")){
          ...
          $sql = "INSERT INTO submitrequest_tb(request_info,request_desc,requester_name,requester_ad1,requester_ad2,requester_city,requester_state,requester_zip,requester_email,requester_mobile,request_date)VALUES('$rinfo','$rdesc','$rname','$radd1','$radd2','$rcity','$rstate','$rzip','$remail','$rmobile','$rdate')";
          if($conn->query($sql) == TRUE){
              $genid=mysqli_insert_id($conn);
            $msg="<div class='alert alert-success col-sm-6 ml-5 mt-2'>Request Submited Successfully</div>";
            $_SESSION['myid']=$genid;
...
?>
<div class="col-9 col-md-10 mt-5"><!--start 2nd column-->
<form class="mx-5"action=""method="POST">
    <div class="form-group">
        <lebel for="inputRequest">Request Info</lebel>
        <input type="text" class="form-control" id="inputRequestInfo" placeholder="Request Info" name="requestinfo">
    </div>
     <div class="form-group">
         <lebel for="inputRequestDescription">Description</lebel>
         <input type="text" class="form-control" id="inputRequestDescription" placeholder="Write Description" name="requestdesc">
     </div>
     <div class="form-group">
         <lebel for="inputName">Name</lebel>
         <input type="text" class="form-control" id="inputName" placeholder="Tahshin" name="requestername">
     </div>
     <div class="form-row">
         <div class="form-group col-md-6">
             <level for="inputAddress">Address Line 1</level>
             <input type="text" class="form-control" id="inputAddress" placeholder="House No:123" name="requesteradd1">
         </div>
         <div class="form-group col-md-6">
             <label for="inputAddress2">Address Line 2</label>
             <input type="text" class="form-control" id="inputAddress2" placeholder="Dhunat,Bogra" name="requesteradd2">
         </div>
     </div>
     <div class="form-row">
         <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-2">
             ...
             <input type="text" class="form-control" id="inputMobile" name="requestermobile" onekeypress="isInputNumber(event)">
         </div>
         <div class="form-group col-md-2">
